...
<h2>SIG do Fluxo Veícular na notação do NFR Framework</h2>

<table>
  <tr>
    <td align="center">
      <img src="{{ '/imagens/NFR_FRAMEWORK.png' | relative_url }}" width="300">
      <br>
      <em>Legenda da primeira imagem</em>
    </td>
    <td align="center">
      <img src="{{ '/imagens/NFR_COM_IA.png' | relative_url }}" width="300">
      <br>
