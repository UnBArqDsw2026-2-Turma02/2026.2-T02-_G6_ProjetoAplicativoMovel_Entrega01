...
Os artefatos foram versionados em formato editável, além da imagem exportada, de modo que o histórico do repositório mostra a contribuição de cada integrante.
...
![Mapa mental mermaid](../assets/mapa_mental-sub02.svg)

<!-- **Versão textual de referência (Mermaid):** -->
<!-- tentei arrumar pelo index.html mas estava dando dobreposição nos textos, passei o codigo no editor e exportei a imagem mesmo -->
...
| mermaid | Compilação do código do mapa mental e exportação em SVG |
| Git / GitHub | Versionamento dos artefatos e rastreabilidade das contribuições |
| [site do senatran](https://portalservicos.senatran.serpro.gov.br/static/carteiradigital/tutoriais/html/demo_22.html) | Exemplo de fluxo para acesso à infrações por veículo |
...
Através da interação com o aplicatico foi notado os seguintes fluxos: 
...
Além da visualização no próprio aplicativo foi acessado o [site do senatran](https://portalservicos.senatran.serpro.gov.br/static/carteiradigital/tutoriais/html/demo_22.html) para ver funções que necessitam de infrações para prosseguir (usado para se aprofundar no fluxo de infrações por veículo)
...
<!-- [Arquivo editável BPMN](../assets/diagram.bpmn) -->
...
| 4.2 Visualização de Infrações | `Visualização de Infrações` | Matheus Pinheiro (infração por veículo: visualização/solicitação de boleto e solicitação de descontos) |
| 4.3 Processo de Suspensão da CNH | | [COLEGA C] |

##### 4.2 Visualização de infrações

![BPMN Visualização de infrações](../assets/BPMN_2_4-2.svg)
...
|---|---|---|
| Felipe Henrique Oliveira Sousa | [Estruturação do relatório, pesquisa normativa (CTB, CONTRAN), Mapa Mental (estrutura base + subfluxo ), ramo de Integridade no SIG, Engenharia Reversa do subfluxo e modelagem BPMN do fluxo integrado](https://github.com/UnBArqDsw2026-2-Turma02/2026.2-T02-_G6_ProjetoAplicativoMovel_Entrega01/commit/ae5e8dba18268e899e832d297765edf44a450bb8) | 27/08/2026 |
| Matheus Pinheiro | [Remodelagem do BPMN de fluxo integrado de inrfações no bpmn.io para seguir as normas](https://github.com/UnBArqDsw2026-2-Turma02/2026.2-T02-_G6_ProjetoAplicativoMovel_Entrega01/commit/89458eb5df34c1887253e557b0262ca0e2efe726) | 27/08/2026 |
| Matheus Pinheiro | [Alteração no mapa mental subfluxo 4.2 para seguir o BPMN que será criado](https://github.com/UnBArqDsw2026-2-Turma02/2026.2-T02-_G6_ProjetoAplicativoMovel_Entrega01/commit/89458eb5df34c1887253e557b0262ca0e2efe726) | 27/08/2026 |
| Matheus Pinheiro | [Criação do BPMN do subfluxo 4.2 e explicação da engenharia reversa para criação do fluxo](https://github.com/UnBArqDsw2026-2-Turma02/2026.2-T02-_G6_ProjetoAplicativoMovel_Entrega01/commit/89458eb5df34c1887253e557b0262ca0e2efe726) | 27/08/2026 |
| Matheus Pinheiro | [Criação do NFR, notação BPMN usada e preenchimento da tabela do foco 3](https://github.com/UnBArqDsw2026-2-Turma02/2026.2-T02-_G6_ProjetoAplicativoMovel_Entrega01/commit/b0cb16a726527ff63f94b91960e5c0a2e336ee72) | 28/08/2026 |
| Matheus Pinheiro | [Separação de infração por veículo como sub-processo colapsado no BPMN e adição de autores nos diagramas criados](https://github.com/UnBArqDsw2026-2-Turma02/2026.2-T02-_G6_ProjetoAplicativoMovel_Entrega01/commit/baeb3023cd8dd262e603c153f0bc4235e41d07be) | 28/08/2026 |
 Matheus Pinheiro | [Inclusão do site do senatran na tabela de Ferramentas e link de commits no versionamento](https://github.com/UnBArqDsw2026-2-Turma02/2026.2-T02-_G6_ProjetoAplicativoMovel_Entrega01/commit/7f9f040d818e126a2a6b2f39a3b807aaa43c4130) | 28/08/2026 |
 Matheus Pinheiro | Alteração do mapa mental do mermaid para SVG garantindo compilação | 28/08/2026 |
