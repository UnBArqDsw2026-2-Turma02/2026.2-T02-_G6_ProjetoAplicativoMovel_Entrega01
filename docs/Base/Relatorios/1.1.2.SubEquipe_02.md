...
| 4.2 Visualização de Infrações | | Matheus Pinheiro (visualização de boleto, solicitação de boleto e solicitação de descontos) |
| 4.3 Processo de Suspensão da CNH | | [COLEGA C] |

##### 4.2 Vizualização de infrações

![BPMN Vizualização de infrações](<BPMN_2_4-2.svg>)
...
| Matheus Pinheiro |  | Não utilizado |
| [COLEGA C] |  |  |
